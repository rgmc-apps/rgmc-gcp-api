...
tags_metadata = [
    ...
    {
        "name": "BC RGMC Items",
        "description": "RGMC custom API — Item read endpoints (Pag50205, api/rgmc/rgmccustom/v1.0).",
    },
    {
        "name": "BC RGMC Item Families",
        "description": "RGMC custom API — Item Family read endpoints (Pag50206, api/rgmc/rgmccustom/v1.0).",
    },
    {
        "name": "BC RGMC Item Prices",
        "description": "RGMC custom API — Item Price read endpoints (Pag50210, api/rgmc/rgmccustom/v1.0).",
    },
    {
        "name": "BC RGMC Sales Orders",
        "description": "RGMC custom API — Sales Order and Lines CRUD endpoints (Pag50216/Pag50217, api/rgmc/rgmccustom/v1.0).",
    },
]
...
try:
    ...
    api.include_router(mssql_router)
